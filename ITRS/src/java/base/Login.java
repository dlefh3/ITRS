...
public class Login extends HttpServlet
{
    ...
    throws ServletException, IOException
    {
        ...
        String acctNum = request.getParameter("acct_num");
        ...
        try
        {
            ...
            ResultSet r = s.executeQuery("SELECT * FROM employee NATURAL JOIN department WHERE emp_acctnum ='" + acctNum + "'");
            if (r.next())
            {
                emp = new Employee();
                emp.setEmployee(r);
                emp.setLoggedIn(password);
            ...
            {
                message = "Unknown user: " + acctNum + ". UserID not found.";
            }
        }
