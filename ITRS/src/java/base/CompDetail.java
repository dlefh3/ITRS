 ...
 * @author Daniel
 */
public class CompDetail extends HttpServlet {
    ...
    throws ServletException, IOException
    {
        ...
        try
        {
            String compNum = request.getParameter("comp_num");
            String url="/Main.jsp";
            String message = "";
            ...
            try
            {
                url = "/ViewCompDetail.jsp";
                Connection conn = DriverManager.getConnection(dbURL,username,dbpassword);
                Statement s = conn.createStatement();
                String qry = "SELECT * FROM comprequest NATURAL JOIN department" +
                ...
                while (r.next())
                    {
                        ...
                        c.setRequest(r);
                        request.getSession().setAttribute("comp", c);
                    }
            }
